 ...
 * 
 * Compile: g++ -std=c++20 -O2 -I../include -o stabbing_line_demo stabbing_line_demo.cpp
...
int main() {
    ...
    if (!userPoints.empty()) {
        std::cout << "\nPoints entered: " << userPoints.size() << "\n";
        std::cout << "\nYour result:\n"; // Added this line to restore context
        printResult(sls, userPoints, epsilon); // Corrected this line to maintain functionality
    }
